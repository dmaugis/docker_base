...
# Get OpenCV
git clone  --progress --verbose https://github.com/opencv/opencv.git opencv
cd opencv 
git checkout 3.4.2
cd ..
# Get OpenCV contrib modules
git clone  --progress --verbose https://github.com/opencv/opencv_contrib.git opencv_contrib
cd opencv_contrib
git checkout 3.4.2
cd ..
...
cmake -D CMAKE_BUILD_TYPE=RELEASE \
      -D CMAKE_INSTALL_PREFIX=/usr/local/opencv3.4.2 \
